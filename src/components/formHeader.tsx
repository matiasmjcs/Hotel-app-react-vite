...
export const FormHeader = () => {
    return (
        <form className="grid grid-cols-1 grid-rows-4 md:flex md:h-[50px] justify-items-center p-2 w-full  relative top-28 gap-1 transparent rounded-lg justify-between">
            ...
            <input id="checkin" className="bg-transparent px-2 w-[200px] md:w-[150px]" type="date" />
            <input id="checkout" className="bg-transparent px-2 w-[200px] md:w-[150px]" type="date" />
