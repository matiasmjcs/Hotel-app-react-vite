...
export const LoginComponent = () => {
    ...
    return (
        <form onSubmit={login} className="max-w-md min-h-[200px] my-2 mx-auto flex flex-col items-center justify-center gap-2 md:w-[400px] text-black p-2 rounded-lg shadow-md">
